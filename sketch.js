...
//  text("당첨횟수 : " + LUCKS,10,30);
  ...
  text("공지사항 :",10, 205)
  textSize(10)
  text("2.4.5 업데이트 내용:",10, 216)
  text("게임오버 관련 버그 픽스",10, 227)
  text("오토마우스 관련 버그 픽스",10, 238)
  text("오토클릭 감지 횟수 (15이상 차단) =" + NOautoClick, 174, 162)
  text("1vs1 확률 밸런스로 인해",10, 249)
  text("3강 (강화 성공 횟수 3) 부터",10, 260)
  text("1vs1 사용 가능하게 패치",10, 271)
  text(" ",10, 282)
  text(" ",10, 293)
  text(" ",10, 304)
  text("2.4.5-2024/6/6",163, 22)
  textSize(15)
...
//secret credits
        ...
        textSize(13)
        text ("GAME made by - @j_ho.103",50,75)
